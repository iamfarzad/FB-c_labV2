    ...
    <div className={cn(
      ...
      <div className="absolute bottom-10 flex w-full flex-col items-center">
        ...
        <div className="absolute -top-3 z-20 flex items-center justify-center rounded-lg border bg-background px-2 py-1 sm:-top-4 sm:py-1.5">
          ...
          <span className="ml-2 text-[10px] text-accent-foreground">
            {title}
          </span>
        </div>
        ...
        <div className="relative z-10 flex h-[150px] w-full items-center justify-center overflow-hidden rounded-lg border bg-background shadow-md">
          {/* Badges */}
          <div className="absolute bottom-8 left-12 z-10 flex h-7 items-center gap-2 rounded-full border bg-background px-3 text-xs">
            <HeartHandshakeIcon className="size-4 text-accent-foreground" />
            <span className="text-accent-foreground">{buttonTexts.first}</span>
          </div>
          <div className="absolute right-16 z-10 hidden h-7 items-center gap-2 rounded-full border bg-background px-3 text-xs sm:flex">
