...
const Beam = ({
  ...
  // Orange brand color variations (different shades/opacity)
  const orangeShades = [
    '#FF5B04',      // Main orange
    '#FF8F6A',      // Light orange
    '#E65200',      // Dark orange
    '#FF7341',      // Medium orange
    '#FF4500',      // Red-orange
  ];
  
  const selectedOrange = orangeShades[Math.floor(Math.random() * orangeShades.length)];
